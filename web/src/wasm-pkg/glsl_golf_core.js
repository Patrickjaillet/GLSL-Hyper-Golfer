...
export function golf_json_protected(source, eliminate_dead_locals, eliminate_dead_stores, fold_constants, reduce_constant_vectors, strip_trailing_void_return, compound_assignments, increment_decrement, ternary_from_if_else, merge_declarations, strip_redundant_braces, strip_redundant_parens, strip_duplicate_precision, protected_names) {
    ...
    try {
        ...
        const ret = wasm.golf_json_protected(ptr0, len0, eliminate_dead_locals, eliminate_dead_stores, fold_constants, reduce_constant_vectors, strip_trailing_void_return, compound_assignments, increment_decrement, ternary_from_if_else, merge_declarations, strip_redundant_braces, strip_redundant_parens, strip_duplicate_precision, ptr1, len1);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
