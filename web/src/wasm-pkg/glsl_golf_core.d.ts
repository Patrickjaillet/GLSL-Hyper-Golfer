 ...
 * as `golf_json`.
 */
export function golf_json_ex(source: string, eliminate_dead_locals: boolean, eliminate_dead_stores: boolean, fold_constants: boolean, reduce_constant_vectors: boolean, strip_trailing_void_return: boolean, compound_assignments: boolean, merge_declarations: boolean, strip_redundant_braces: boolean): string;
...
export interface InitOutput {
    ...
    readonly golf_json_ex: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number];
