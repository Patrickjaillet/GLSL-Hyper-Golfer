...
const fr: Dict = {
  ...
  "sidebar.toggle.title": "Replier/déplier la barre latérale",
  "sound.toggle.title.on": "Désactiver le bip sonore (run/erreur)",
  "sound.toggle.title.off": "Activer un bip sonore discret (run/erreur)",
  "zen.enter.title": "Plein écran furtif (masque toute l'interface, Échap pour sortir)",
  "zen.exit.title": "Quitter le plein écran furtif (ou Échap)",
  "log.runOk": "golf exécuté ({pct} réduit)",
  "log.runError": "erreur de compilation — golf non appliqué au viewport",
  "log.screenshot": "capture d'écran enregistrée (PNG)",
  "log.recordStart": "enregistrement vidéo démarré",
  "log.recordStop": "enregistrement terminé, vidéo téléchargée (WebM)",
  "log.exportOk": "projet exporté (JSON Shadertoy)",
  "log.importOk": "import Shadertoy réussi",
...
const en: Dict = {
  ...
  "sidebar.toggle.title": "Collapse/expand the sidebar",
  "sound.toggle.title.on": "Turn off the run/error beep",
  "sound.toggle.title.off": "Turn on a discreet run/error beep",
  "zen.enter.title": "Stealth fullscreen (hides the whole interface, Esc to exit)",
  "zen.exit.title": "Exit stealth fullscreen (or Esc)",
  "log.runOk": "golf run ({pct} reduced)",
  "log.runError": "compile error — golf not applied to the viewport",
  "log.screenshot": "screenshot captured (PNG)",
  "log.recordStart": "video recording started",
  "log.recordStop": "recording finished, video downloaded (WebM)",
  "log.exportOk": "project exported (Shadertoy JSON)",
  "log.importOk": "Shadertoy import succeeded",
